...
(defcustom post-variable-signature-source "~/.mutt/sigs/variables"
...
(defcustom post-fixed-signature-source "~/.mutt/sigs/fixed"
  "*File with the fixed part of your signature."
  :type 'string
  :group 'post)

(defcustom post-signature-directory "~/.mutt/sigs/"
  "*The directory that contains your collection of signature files."
  :type 'string
  :group 'post)

(defcustom post-signature-wildcard "*"
  "*Wildcard for finding signature files in your signature directory."
  :type 'string
  :group 'post)

(defcustom post-random-signature-command "fortune -s bofh-excuses wisdom"
