...
"""
Usage: sync_mail.py [--user login] [--imap user:pass@server{box, ...}]
"""
...
class Synchroniser(object):
    ...
    The Synchroniser is able to build a isync configuration file on
    ...
    def __init__(self, conf):
        self._logger = create_logger(self.__class__.__name__)
        self._conf = conf
        self._conf = self._build_configuration()
